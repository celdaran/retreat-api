INSERT INTO `account_type` (`account_type_id`, `account_type_name`, `created_at`, `modified_at`) VALUES
  ...
  (3, 'Income', '2024-01-15 20:14:59', '2024-01-15 20:14:59')
;
...
INSERT INTO `scenario` (`scenario_name`, `scenario_descr`, `account_type_id`, `created_at`, `modified_at`) VALUES
  ...
  ('Default', 'Default Income Scenario', 3, '2024-01-15 20:15:41', '2024-01-15 20:15:41')
;

INSERT INTO `simulation` (`simulation_name`, `simulation_descr`, `scenario_id__expense`, `scenario_id__asset`, `scenario_id__income`, `tax_rate`, `periods`, `start_year`, `start_month`, `created_at`, `modified_at`) VALUES 
  ('First Simulation', NULL, '1', '2', '3', '0.25', '300', '2026', '1', '2024-01-20 05:12:44', '2024-01-20 05:12:44')
;
